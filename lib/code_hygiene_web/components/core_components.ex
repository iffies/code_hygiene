defmodule CodeHygieneWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CodeHygieneWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CodeHygieneWeb.Gettext, "errors", msg, opts)
    end
  end
